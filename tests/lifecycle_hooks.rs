...
pub mod tracked_author {
    ...
    #[ormada_model(table = "tracked_authors", hooks = true)]
...
pub mod blocking_author {
    ...
    // hooks = true means we'll provide our own LifecycleHooks implementation
    #[ormada_model(table = "blocking_authors", hooks = true)]
...
pub mod full_hooks_author {
    ...
    // hooks = true means we'll provide our own LifecycleHooks implementation
    #[ormada_model(table = "full_hooks_authors", hooks = true)]
...
pub mod default_hooks_author {
    ...
    #[ormada_model(table = "default_hooks_authors")]
