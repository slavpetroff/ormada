//! Code generation utilities for the django_model macro
//!
//! This module contains helpers that generate SeaORM-compatible code
//! using paths through `::seaorm_django::__internal::` instead of `::sea_orm::`.
...
pub fn generate_entity(table_name: &str, fields: &[FieldInfo]) -> TokenStream {
    ...
    quote! {
        ...
        impl ::seaorm_django::__internal::EntityName for Entity {
        ...
        impl ::seaorm_django::__internal::IdenStatic for Entity {
            fn as_str(&self) -> &str {
                #table_name
            }
        }
        
        impl ::seaorm_django::__internal::Iden for Entity {
            fn unquoted(&self, s: &mut dyn ::std::fmt::Write) {
                ::std::write!(s, "{}", #table_name).unwrap();
            }
        }
        
        impl ::seaorm_django::__internal::EntityTrait for Entity {
            type Model = Model;
            type Column = Column;
...
pub fn generate_column_enum(fields: &[FieldInfo]) -> TokenStream {
    ...
    quote! {
        ...
        impl ::seaorm_django::__internal::IdenStatic for Column {
            fn as_str(&self) -> &str {
                match self {
        ...
        impl ::seaorm_django::__internal::Iden for Column {
            fn unquoted(&self, s: &mut dyn ::std::fmt::Write) {
                ::std::write!(s, "{}", ::seaorm_django::__internal::IdenStatic::as_str(self)).unwrap();
            }
        }
        
        impl ::seaorm_django::__internal::IntoIden for Column {
            fn into_iden(self) -> ::seaorm_django::__internal::sea_orm::sea_query::DynIden {
                ::seaorm_django::__internal::sea_orm::sea_query::SeaRc::new(self)
            }
        }
        
        impl ::seaorm_django::__internal::ColumnTrait for Column {
            type EntityName = Entity;
            
            fn def(&self) -> ::seaorm_django::__internal::ColumnDef {
                match self {
...
fn get_column_type_tokens(ty: &syn::Type, is_nullable: bool) -> TokenStream {
    ...
    let base_def = if type_str.contains("i32") || type_str.contains("i64") {
        quote! { ::seaorm_django::__internal::ColumnType::Integer.def() }
    } else if type_str.contains("String") {
        quote! { ::seaorm_django::__internal::ColumnType::String(::core::option::Option::None).def() }
    } else if type_str.contains("bool") {
        quote! { ::seaorm_django::__internal::ColumnType::Boolean.def() }
    } else if type_str.contains("f32") || type_str.contains("f64") {
        quote! { ::seaorm_django::__internal::ColumnType::Double.def() }
    } else if type_str.contains("DateTimeWithTimeZone") || type_str.contains("DateTime") {
        quote! { ::seaorm_django::__internal::ColumnType::TimestampWithTimeZone.def() }
    } else if type_str.contains("Uuid") {
        quote! { ::seaorm_django::__internal::ColumnType::Uuid.def() }
    } else {
...
pub fn generate_primary_key(pk_fields: &[FieldInfo]) -> TokenStream {
    ...
    quote! {
        ...
        impl ::seaorm_django::__internal::PrimaryKeyToColumn for PrimaryKey {
            type Column = Column;
...
pub fn generate_active_model(fields: &[FieldInfo]) -> TokenStream {
    ...
    quote! {
        ...
        pub struct ActiveModel {
            #(pub #field_names: ::seaorm_django::__internal::ActiveValue<#field_types>,)*
        }
        
        impl ::seaorm_django::__internal::ActiveModelTrait for ActiveModel {
            type Entity = Entity;
            
            fn take(&mut self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column) -> ::seaorm_django::__internal::ActiveValue<::seaorm_django::__internal::Value> {
                match c {
                    #(Column::#pascal_names => {
                        let mut value = ::seaorm_django::__internal::ActiveValue::NotSet;
            ...
            fn get(&self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column) -> ::seaorm_django::__internal::ActiveValue<::seaorm_django::__internal::Value> {
                match c {
                    #(Column::#pascal_names => self.#field_names.clone().into_value().unwrap(),)*
                }
            }
            
            fn set(&mut self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column, v: ::seaorm_django::__internal::Value) {
                match c {
                    #(Column::#pascal_names => self.#field_names = ::seaorm_django::__internal::ActiveValue::Set(v.unwrap()),)*
                }
            }
            
            fn not_set(&mut self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column) {
                match c {
                    #(Column::#pascal_names => self.#field_names = ::seaorm_django::__internal::ActiveValue::NotSet,)*
                }
            }
            
            fn is_not_set(&self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column) -> bool {
                match c {
            ...
            fn default() -> Self {
                Self {
                    #(#field_names: ::seaorm_django::__internal::ActiveValue::NotSet,)*
                }
            }
            
            fn reset(&mut self, c: <Self::Entity as ::seaorm_django::__internal::EntityTrait>::Column) {
                match c {
                    #(Column::#pascal_names => self.#field_names = ::seaorm_django::__internal::ActiveValue::NotSet,)*
                }
            }
        ...
        impl ::core::convert::From<Model> for ActiveModel {
            fn from(model: Model) -> Self {
                Self {
                    #(#field_names: ::seaorm_django::__internal::Set(model.#field_names),)*
                }
            }
        }
        
        impl ::seaorm_django::__internal::IntoActiveModel<ActiveModel> for Model {
